...
#			}
	...
	unless ($FORM{action} eq "tailcmd" or $FORM{action} =~ /^cf/ or $FORM{action} eq "logtailcmd" or $FORM{action} eq "loggrepcmd") {
		...
		print "<p>&copy;2006-2020, <a href='http://www.configserver.com' target='_blank'>ConfigServer Services</a> (Way to the Web Limited)</p>\n";
		print "</div>\n";
	}
...
#	&confirmmodal;
sub confirmmodal {
	print "<div class='modal fade' id='confirmmodal' tabindex='-1' role='dialog'  aria-labelledby='myModalLabel' aria-hidden='true'>\n";
